...
from advanced_daily_trainset_code.dl_model.model_test.bio_model.v14_base_model.v14_LoadData import get_input_data
from advanced_daily_trainset_code.dl_model.model_test.bio_model.v14_base_model.v14_bio_clustering import make_cluster
...
from advanced_daily_trainset_code.dl_model.model_test.bio_model.v14_base_model.v14_HDNN import HDNN
from advanced_daily_trainset_code.dl_model.model_test.bio_model.v14_base_model.v14_model_config import model_config as mc
from advanced_daily_trainset_code.dl_model.model_test.bio_model.v14_base_model.v14_utils import seed_everything, weighted_random_sampler, \
...
# 모델 경로 설정
model_path = "D:/주식회사빅밸류 Dropbox/김낙겸/19. 2025 업무/250101 농림축산검역본부/250428_ASF 분석 데이터 구축/모델 결과/방역 모델/v14_baseline_model"
...
for train_year, test_year in train_test_pairs:
    ...
    cluster_order = ["미사육", "미사육+모돈_사육", "소형", "소형+모돈_사육", "중형", "중형+모돈_사육", "대형", "대형+모돈_사육"]

    train_df_final['cluster'].unique()
    test_df_final['cluster'].unique()
...
# 학습 클러스터별 예측값
train = pd.read_parquet(r"D:\주식회사빅밸류 Dropbox\김낙겸\19. 2025 업무\250101 농림축산검역본부\250428_ASF 분석 데이터 구축\모델 결과\방역 모델\v14_baseline_model\train_result.parquet")
tot = (
...
# 검증 클러스터별 예측값
test = pd.read_parquet(r"D:\주식회사빅밸류 Dropbox\김낙겸\19. 2025 업무\250101 농림축산검역본부\250428_ASF 분석 데이터 구축\모델 결과\방역 모델\v14_baseline_model\test_result.parquet")
tot = (

...
from advanced_daily_trainset_code.dl_model.model_test.env_model.base_model.model_config import model_config
...
def get_input_data(train_col_cat = None) :
    ...
    #
    # # 7:3 비율 계산
    # train_size = round(num_dates * 0.7)
    #
    # # 날짜 분할
    # train_dates = date_list[:train_size] # 26
    # test_dates = date_list[train_size:] # 11

    # # 학습/테스트 셋 구분 (20~23/24~25)
    # split_dates = '2024-01-01'
    # test_df = train_df[train_df['standard_date'] >= split_dates]
    # train_df = train_df[train_df['standard_date'] < split_dates]

    # print(train_df['asf_occurrence_yn'].value_counts(),
    #       test_df['asf_occurrence_yn'].value_counts())

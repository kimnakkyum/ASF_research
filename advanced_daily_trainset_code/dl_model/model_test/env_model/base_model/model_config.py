...
class model_config:
    ...
    #
    # # 환경 최종 변수
    # env_col = ['center_forest', 'center_farmland', 'center_urban', 'center_habitat']
    ...
    pred_dim = len(env_col)

    pred_nn_1_multiply_num = 4
    pred_nn_2_multiply_num = 8
    pred_nn_3_multiply_num = 4

...
from advanced_daily_trainset_code.dl_model.model_test.visit_model.v3_base_model.v3_visit_clustering import make_cluster
from advanced_daily_trainset_code.dl_model.model_test.visit_model.v3_base_model.v3_visit_clustering import generate_name_tag
from advanced_daily_trainset_code.dl_model.model_test.visit_model.v3_base_model.v3_HDNN import HDNN
from advanced_daily_trainset_code.dl_model.model_test.visit_model.v3_base_model.v3_model_config import model_config as mc
from advanced_daily_trainset_code.dl_model.model_test.visit_model.v3_base_model.v3_utils import seed_everything, weighted_random_sampler, \
...
# 모델 경로 설정
model_path = "D:/주식회사빅밸류 Dropbox/김낙겸/19. 2025 업무/250101 농림축산검역본부/250428_ASF 분석 데이터 구축/모델 결과/전파 모델/v3_baseline_model_test"
...
# 학습 클러스터별 예측값
train = pd.read_parquet(r"D:\주식회사빅밸류 Dropbox\김낙겸\19. 2025 업무\250101 농림축산검역본부\250428_ASF 분석 데이터 구축\모델 결과\전파 모델\v3_baseline_model_test\train_result.parquet")
tot = (
...
# 검증 클러스터별 예측값
test = pd.read_parquet(r"D:\주식회사빅밸류 Dropbox\김낙겸\19. 2025 업무\250101 농림축산검역본부\250428_ASF 분석 데이터 구축\모델 결과\전파 모델\v3_baseline_model_test\test_result.parquet")
tot = (
